...
class Transaction:
  ...
  def add_item(self, item_detail):
    ...
    print(f"Purchased order : {self.order}")
  ...
  def delete_item(self, item_name):
    '''
    create a delete_item method that contains the item_name parameter which is used to delete one of the order you
    want to delete
